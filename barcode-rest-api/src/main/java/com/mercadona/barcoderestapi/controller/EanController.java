...
public class EanController {
    ...
    public ResponseEntity<Object> getEan13(@PathVariable String ean13) {
        ...
        Product product = productService.getById(Integer.parseInt(ean13Map.get("productBarcode"))).orElse(null);
        Provider provider = providerService.getById(Integer.parseInt(ean13Map.get("providerBarcode"))).orElse(null);
